          ...
          <div class="row row-30 justify-content-center bordered-1">
            <div class="col-sm-4">
              <div class="counter-classic">
                <h1 class="counter-classic-number"><span class="counter">100</span>
                </h1>
                <div class="counter-classic-decor"></div>
                <h5 class="counter-classic-title">Stores around<br class="d-none d-sm-block"> the usa</h5>
              </div>
            </div>
            <div class="col-sm-4">
              <div class="counter-classic">
                <h1 class="counter-classic-number"><span class="counter">100</span><span class="symbol">+</span>
                </h1>
                <div class="counter-classic-decor"></div>
                <h5 class="counter-classic-title">Reliable <br class="d-none d-sm-block"> partners</h5>
              </div>
            </div>
            <div class="col-sm-4">
              <div class="counter-classic">
                <h1 class="counter-classic-number"><span class="counter">50</span>
                </h1>
                <div class="counter-classic-decor"></div>
                <h5 class="counter-classic-title">Qualified<br class="d-none d-sm-block"> team members</h5>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="row row-30 justify-content-center">
              <div class="col-6 col-sm-3">
                <div class="counter-modern">
                  <h2 class="counter-modern-number"><span class="counter">24</span>
                  </h2>
                  <div class="counter-modern-decor"></div>
                  <h5 class="counter-modern-title">Cities</h5>
                </div>
              </div>
              <div class="col-6 col-sm-3">
                <div class="counter-modern">
                  <h2 class="counter-modern-number"><span class="counter">100000</span>
                  </h2>
                  <div class="counter-modern-decor"></div>
                  <h5 class="counter-modern-title">Products</h5>
                </div>
              </div>
              <div class="col-6 col-sm-3">
                <div class="counter-modern">
                  <h2 class="counter-modern-number"><span class="counter">243987</span>
                  </h2>
                  <div class="counter-modern-decor"></div>
                  <h5 class="counter-modern-title">Satisfied customers</h5>
                </div>
              </div>
              <div class="col-6 col-sm-3">
                <div class="counter-modern">
                  ...
                  <div class="counter-modern-decor"></div>
                  <h5 class="counter-modern-title">Partners</h5>
                </div>
              </div>
            </div>
          </div>
