              ...
              <div class="rd-navbar-main">
                ...
                <div class="rd-navbar-nav-wrap">
                  <ul class="rd-navbar-nav">
                    ...
                    <li class="rd-nav-item active"><a class="rd-nav-link" href="grid-blog.php">Blog</a>
                      <ul class="rd-menu rd-navbar-dropdown">
                        <li class="rd-dropdown-item active"><a class="rd-dropdown-link" href="blog-post.html">Blog Post</a>
                        </li>
                      </ul>
                    </li>
                ...
                <div class="row row-50 row-md-60 row-lg-80">
                  <div class="col-12">
                    <article class="post post-modern-1 box-xxl">
                      <div class="post-modern-panel">
                        <div><a class="post-modern-tag" href="#">Smartphones</a></div>
                        <div>
                          <time class="post-modern-time" datetime="2021-09-08">August 9, 2021</time>
                        </div>
                      </div>
                      <h3 class="post-modern-title">Best Android Smartphones to Buy in 2021.</h3>
                      <div class="post-modern-figure"><img src="assets/images/post-7-800x394.jpg" alt="" width="800" height="394"/>
                      </div>
                    ...
                    <article class="quote-classic quote-classic-2">
                      <div class="quote-classic-text">
                        <div class="q">We’ve tested all of the most popular Android phones in all shapes, sizes and prices at Techzoid.</div>
                      </div>
                    </article>
                    ...
                    <div class="single-post-bottom-panel">
                      <div class="group-sm group-justify">
                        <div>
                          <div class="group-sm group-tags"><a class="link-tag" href="#">Smartphones</a><a class="link-tag" href="#">Laptops</a><a class="link-tag" href="#">Headphones</a></div>
                        </div>
                        <div>
                  ...
                  <div class="col-12">
                    ...
                    <div class="row row-30">
                      <div class="col-sm-6">
                        <!-- Post Classic-->
                        <article class="post post-classic box-md"><a class="post-classic-figure" href="blog-post.html"><img src="assets/images/post-1-370x239.jpg" alt="" width="370" height="239"/></a>
                          <div class="post-classic-content">
                            <div class="post-classic-time">
                              <time datetime="2021-09-08">August 9, 2021</time>
                            </div>
                            <h5 class="post-classic-title"><a href="blog-post.html">Top 10 Wireless Headphones for Your Smartphone</a></h5>
                      ...
                      <div class="col-sm-6">
                        <!-- Post Classic-->
                        <article class="post post-classic box-md"><a class="post-classic-figure" href="blog-post.html"><img src="assets/images/post-2-370x239.jpg" alt="" width="370" height="239"/></a>
                          <div class="post-classic-content">
                            <div class="post-classic-time">
                              <time datetime="2021-09-08">August 9, 2021</time>
                            </div>
                            <h5 class="post-classic-title"><a href="blog-post.html">What Accessories You Should Use with a New Laptop</a></h5>
                  ...
                  <div class="col-12">
                    ...
                    <div class="box-comment">
                      <div class="unit flex-column flex-sm-row unit-spacing-md">
                        <div class="unit-left"><a class="box-comment-figure" href="#"><img src="assets/images/user-1-119x119.jpg" alt="" width="119" height="119"/></a></div>
                        <div class="unit-body">
                          <div class="group-sm group-justify">
                            <div>
                              <div class="group-xs group-middle">
                      ...
                      <div class="box-comment">
                        <div class="unit flex-column flex-sm-row unit-spacing-md">
                          <div class="unit-left"><a class="box-comment-figure" href="#"><img src="assets/images/user-2-119x119.jpg" alt="" width="119" height="119"/></a></div>
                          <div class="unit-body">
                            <div class="group-sm group-justify">
                              <div>
                                <div class="group-xs group-middle">
                            ...
                            <p class="box-comment-text">Sed in ligula et eros dignissim aliquam. Nam ut odio dolor. Sed tempor sodales vulputate. Quisque sed odio ut mi consequat venenatis in a libero.</p>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="box-comment">
                      <div class="unit flex-column flex-sm-row unit-spacing-md">
                        <div class="unit-left"><a class="box-comment-figure" href="#"><img src="assets/images/user-3-119x119.jpg" alt="" width="119" height="119"/></a></div>
                        <div class="unit-body">
                          <div class="group-sm group-justify">
                            <div>
                              <div class="group-xs group-middle">
                          ...
                          <p class="box-comment-text">Duis risus urna, convallis non vestibulum et, pretium ut enim. Sed ullamcorper metus nisl, in laoreet tortor facilisis in. Sed enim augue, tristique vitae metus ac, posuere auctor nulla. Pellentesque faucibus velit eu mauris eleifend, nec placerat arcu malesuada.</p>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div class="col-lg-4 col-xl-3">
              <div class="aside row row-30 row-md-50 justify-content-md-between">
                <div class="aside-item col-12">
                  <div class="team-info box-sm"><a class="team-info-figure" href="#"><img src="assets/images/user-4-123x123.jpg" alt="" width="123" height="123"/></a>
                    <h6 class="team-info-title"><a href="#">Caroline Lopez</a></h6>
                    <p class="team-info-text">I am the leading editor and blogger at Techzoid website.</p>
                  </div>
                  <!-- RD Search Form-->
                ...
                <div class="aside-item col-sm-6 col-md-5 col-lg-12">
                  ...
                  <ul class="list-categories">
                    ...
                    <li><a href="#">Smartphones</a><span class="list-categories-number">(9)</span></li>
                    <li><a href="#">Laptops</a><span class="list-categories-number">(5)</span></li>
                    <li><a href="#">Headphones</a><span class="list-categories-number">(8)</span></li>
                  </ul>
                </div>
                <div class="aside-item col-sm-6 col-lg-12">
                  ...
                  <div class="row row-20 row-lg-30 gutters-10">
                    <div class="col-6 col-lg-12">
                      ...
                      <article class="post post-minimal">
                        <div class="unit unit-spacing-sm flex-column flex-lg-row align-items-lg-center">
                          <div class="unit-left"><a class="post-minimal-figure" href="blog-post.html"><img src="assets/images/post-mini-1-106x104.jpg" alt="" width="106" height="104"/></a></div>
                          <div class="unit-body">
                            <p class="post-minimal-title"><a href="blog-post.html">Top 10 Wireless Headphones for Your Smartphone</a></p>
                    ...
                    <div class="col-6 col-lg-12">
                      ...
                      <article class="post post-minimal">
                        <div class="unit unit-spacing-sm flex-column flex-lg-row align-items-lg-center">
                          <div class="unit-left"><a class="post-minimal-figure" href="blog-post.html"><img src="assets/images/post-mini-2-106x104.jpg" alt="" width="106" height="104"/></a></div>
                          <div class="unit-body">
                            <p class="post-minimal-title"><a href="blog-post.html">What Accessories You Should Use with a New Laptop</a></p>
                            <div class="post-minimal-time">
                              <time datetime="2021-03-15">March 15, 2021</time>
                            </div>
                          </div>
                ...
                <div class="aside-item col-sm-6 col-md-5 col-lg-12">
                  ...
                  <div class="group-sm group-tags"><a class="link-tag" href="#">Smartphones</a><a class="link-tag" href="#">Cameras</a><a class="link-tag" href="#">Laptopes</a><a class="link-tag" href="#">Tablets</a><a class="link-tag" href="#">Headphones</a><a class="link-tag" href="#">Smart watches</a></div>
                </div>
                <div class="aside-item col-sm-6 col-lg-12">
          ...
          <div class="container">
            <div class="row row-40 row-md-50 justify-content-xl-between">
              ...
              <div class="col-lg-4 wow fadeInRight" data-wow-delay=".2s">
                ...
                <!-- RD Mailform-->
                <form class="rd-form rd-mailform rd-form-inline rd-form-inline-2" data-form-output="form-output-global" data-form-type="subscribe" method="post" action="assets/bat/rd-mailform.php">
                  <div class="form-wrap">
          ...
          <div class="container">
            <div class="row row-10 align-items-center justify-content-sm-between">
              <div class="col-md-auto">
                <p class="rights"><span>&copy;&nbsp;</span><span class="copyright-year"></span><span>&nbsp;</span><span>Techzoid</span><span>.&nbsp; All rights reserved.</span></p>
              </div>
              <div class="col-md-auto order-md-1"><a href="terms-of-use.html">Privacy Policy</a></div>
              <div class="col-md-auto">
                <div class="group-sm group-middle"><img src="assets/images/payment-1-45x15.png" alt="" width="45" height="15"/><img src="assets/images/payment-2-46x28.png" alt="" width="46" height="28"/><img src="assets/images/payment-3-62x17.png" alt="" width="62" height="17"/>
                </div>
              </div>
            </div>
          </div>
