			...
			var regularConstraintsMessages = [
				{
					...
					newMessage: "Este Campo é de Preenchimento Obrigatório."
				},
				{
					type: regula.Constraint.Email,
					newMessage: "O E-mail que Introduziu não é Válido."
				},
				{
					type: regula.Constraint.Numeric,
					newMessage: "Este Campo deve conter apenas Números."
				},
				{
		...
		if (plugins.rdMailForm.length) {
			var i, j, k,
				msg = {
					...
					'MF001': 'O Destinatário não está Configurado!',
					'MF002': 'Não Funciona Localmente!',
					'MF003': 'Por Favor, defina um e-mail no Formulário!',
					'MF004': 'Por favor, defina o tipo de formulário!',
					'MF254': 'Algo deu errado com o PHPMailer!',
					'MF255': 'O Não! Algo deu Errado.'
				};
