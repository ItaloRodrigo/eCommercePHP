...
<html class="wide wow-animation" lang="en">
  ...
  <body>
    ...
    <div class="page">
      <section class="section section-single context-dark bg-image" style="background-image: url(assets/images/bg-404.jpg);">
        <div class="section-single-inner">
          ...
          <div class="section-single-main">
            <div class="container">
              ...
              <h3 class="font-weight-light text-spacing-100">Página não Econtrada</h3><a class="button button-lg button-primary button-zakaria" href="index.php">Voltar</a>
            </div>
          </div>
          <div class="section-single-footer">
            <div class="container text-center">
              <p class="rights"><span>&copy;&nbsp; </span><span class="copyright-year"></span><span>&nbsp;</span><span>ChipMatica, Tecnologia e Serviços</span><span>.&nbsp; Todos os Direitos Reservados.</span><span>&nbsp;</span>
            </div>
          </div>
        </div>
      </section>
