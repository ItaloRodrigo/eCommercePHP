...
<html class="wide wow-animation" lang="en">
  ...
  <body>
    ...
    <div class="page">
      <section class="section section-single context-dark bg-image" style="background-image: url(assets/images/bg-soon.jpg);">
        <div class="section-single-inner">
          ...
          <div class="section-single-main">
            <div class="container">
              ...
              <!-- TimeCircles-->
              <div class="countdown-wrap" data-countdown="data-countdown" data-from="2021-12-31" data-to="2022-12-31">
              ...
              <div class="rd-mailform-wrap">
                <!-- RD Mailform-->
                <form class="rd-form rd-mailform rd-form-inline form-lg" data-form-output="form-output-global" data-form-type="subscribe" method="post" action="assets/bat/rd-mailform.php">
                  ...
                  <div class="form-button wow fadeInRight">
                    <button class="button button-zakaria button-lg button-primary" type="submit">Subscribe</button>
                  </div>
                </form>
              </div>
            </div>
