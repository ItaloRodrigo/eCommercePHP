...
<div class="content mt-5">
    ...
    <form id="register-form" action="javascript:;" method="post">
        <h2 class="login-title">Regista-te</h2>
        <div class="row">
            <div class="col-6">
            ...
            <div class="col-6">
                <div class="form-group">
                    <input class="form-control" type="text" name="last_name" placeholder="Último Nome">
                </div>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <input class="form-control" type="password" name="password_confirmation" placeholder="Confirma a Password">
        </div>
        <div class="form-group text-left">
            <label class="ui-checkbox ui-checkbox-info">
                <input type="checkbox" name="agree">
                <span class="input-span"></span>Eu Concordo com os Termos e Políticas.</label>
        </div>
        <div class="form-group">
            <button class="btn btn-info btn-block" type="submit">Criar Conta</button>
        </div>
        <div class="social-auth-hr">
            <span>Ou Regista-te com</span>
        </div>
        ...
        <div class="text-center">Já estás Registado?
            <a class="color-blue" href="login.php">Faz Login Aqui</a>
        </div>
    </form>
</div>
